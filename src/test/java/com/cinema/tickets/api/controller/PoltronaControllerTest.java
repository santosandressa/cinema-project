...
public class PoltronaControllerTest {
    ...
    static  String POLTRONA_URL = "/api/v1/poltronas";
    ...
    private PoltronaDTO createPoltronaDTO() {
        ...
        poltronaDTO.setCadeira("L1");
        poltronaDTO.setFileira("L");
    ...
    public void shoudCreatePoltrona() throws Exception{
        ...
        poltrona.setId("1");
        poltrona.setCadeira("L1");
        poltrona.setFileira("L");
        ...
        mvc.perform(request)
                ...
                .andExpect(jsonPath("cadeira").value(poltronaDTO.getCadeira()))
